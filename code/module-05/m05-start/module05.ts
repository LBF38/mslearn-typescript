...
class BuildArray {
   ...
   * @returns -1 if a is greater than b, 1 if b is greater than a, 0 if a and b are equal
   */
  ...
  /**
   * buildArray builds an array of unique random numbers containing the number of items based on the number passed to it.
   * The sortOrder parameter determines whether to sort the array in ascending or descending order.
   * @returns an array of numbers sorted in {sortOrder}
   */
  buildArray(): number[] {
